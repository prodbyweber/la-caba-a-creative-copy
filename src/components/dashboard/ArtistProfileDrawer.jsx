                      ...
                      <div className="space-y-4">
                        ...
                        <div className="border-t border-white/[0.04] pt-3">
                          <button
                            ...
                            className="w-full flex items-center justify-center gap-2 px-3 py-2.5 rounded-xl text-xs font-medium text-white/25 hover:text-red-400 hover:bg-red-500/[0.06] border border-white/[0.05] hover:border-red-500/20 transition-all"
                          >
