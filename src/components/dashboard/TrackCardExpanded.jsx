  ...
  return (
    ...
    >
      ...
      <div className="p-2 lg:p-3 flex items-center gap-2 lg:gap-3">
        {/* Cover pequeño con Play */}
        <div className="relative w-12 h-12 lg:w-14 lg:h-14 rounded-lg bg-gradient-to-br from-purple-500/20 to-pink-500/20 flex-shrink-0 overflow-hidden group/cover">
          {track.audio_file_url && (
            <audio
              ...
              preload="metadata"
              playsInline
              onEnded={() => setPlayingMain(false)}
              onPause={() => setPlayingMain(false)}
              onPlay={() => setPlayingMain(true)}
            />
          )}
