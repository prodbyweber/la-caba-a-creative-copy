...
const field = "w-full px-3.5 py-2.5 bg-white/[0.04] border border-white/[0.08] rounded-lg text-white placeholder-white/20 focus:outline-none focus:border-[#ff5833]/50 focus:bg-white/[0.06] transition-all text-sm";
const label = "block text-[10px] font-semibold text-white/30 uppercase tracking-[0.12em] mb-1.5";
          ...
          <div className="flex items-center justify-between px-6 pt-6 pb-5"
            ...
            <div>
              <div className="flex items-center gap-2 mb-0.5">
                <span style={{ width: 6, height: 6, borderRadius: "50%", background: "#ff5833", display: "inline-block" }} />
                <span className="text-[10px] font-semibold uppercase tracking-[0.15em]"
                  style={{ color: "#ff5833" }}>
                  {editData ? "Editar" : "Nueva"} Sesión
                </span>
              </div>
              <h3 className="text-lg font-black text-white" style={{ letterSpacing: "-0.03em", lineHeight: 1 }}>
          ...
          <form onSubmit={handleSubmit} className="px-6 py-5 space-y-5">
            ...
            <div>
              ...
              <textarea value={formData.description}
                ...
                className={field} rows="2" placeholder="Objetivos, materiales, referencias..." />
            </div>
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input type="email" value={newAttendee}
                  ...
                  className={field + " flex-1"} placeholder="correo@ejemplo.com" />
              ...
              {formData.attendees.length > 0 && (
                <div className="mt-2 space-y-1">
                  {formData.attendees.map(email => {
                    ...
                    return (
                      <div key={email} className="flex items-center justify-between px-3 py-1.5 rounded-lg"
                        ...
                        <span className="text-xs" style={{ color: isArtist ? "#ff5833" : "rgba(255,255,255,0.5)" }}>
                          {email}{isArtist && <span style={{ color: "rgba(255,88,51,0.5)", marginLeft: 4 }}>· artista</span>}
                        </span>
                        <button type="button" onClick={() => removeAttendee(email)} className="text-white/20 hover:text-red-400 transition-colors ml-2">
            ...
            <div className="flex gap-2.5">
              ...
              <button type="submit" disabled={isPending}
                className="flex-2 py-2.5 rounded-lg text-sm font-bold transition-all flex items-center justify-center gap-2"
                style={{
                  flex: 2,
                  background: isPending ? "rgba(255,88,51,0.4)" : "#ff5833",
                  color: "white",
                  letterSpacing: "-0.01em",
                  boxShadow: isPending ? "none" : "0 4px 20px rgba(255,88,51,0.3)",
                }}>
                {isPending ? (
