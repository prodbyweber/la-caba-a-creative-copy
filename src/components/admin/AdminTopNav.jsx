...
// En móvil solo muestra logo + perfil; la navegación por secciones la da AdminBottomNav.
              ...
              <Link key={i} to={createPageUrl(item.page)}>
                <button
                  className={`flex items-center gap-1.5 px-3 py-2 text-[11px] font-medium whitespace-nowrap transition-all border-b-2 ${
                    isActive ? "text-white border-white" : "text-white/35 border-transparent hover:text-white/60"
                  }`}
                >
