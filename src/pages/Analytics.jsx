      ...
      <main className="pt-14">
        <div className="px-3 sm:px-6 md:px-12 lg:px-16 xl:px-24 max-w-[1600px] mx-auto py-2 sm:py-3">
          ...
          >
            ...
            <div className="hidden sm:grid grid-cols-8 gap-2 pb-2">
              {topClips.slice(0, 8).map((clip, i) => (
                <motion.div
                  ...
                  className="group relative aspect-[9/16] h-56 rounded-lg overflow-hidden bg-[#111113] border border-white/10 hover:border-emerald-500/30 transition-all cursor-pointer"
                >
                  <img 
                    src={clip.thumbnail} 
                    alt={clip.title}
