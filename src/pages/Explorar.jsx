  ...
  return (
    <div className="min-h-screen bg-[#080808] text-white overflow-x-hidden">
      ...
      {isAdmin && (
        <Link
          to="/ExplorarAdmin"
          className="fixed top-4 right-4 z-50 flex items-center gap-1.5 px-3 py-1.5 bg-black/60 backdrop-blur-sm border border-white/10 rounded-lg text-[10px] font-semibold text-white/40 hover:text-white hover:border-white/25 transition-all"
        >
