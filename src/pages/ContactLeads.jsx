                    ...
                    <div className="flex items-start gap-3 sm:gap-4">
                      ...
                      <div className="flex items-center gap-1.5 flex-shrink-0">
                        ...
                        <a
                          ...
                          className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-white/[0.05] hover:bg-white/10 flex items-center justify-center transition-colors mr-1"
                          title="Enviar email"
                        >
                        ...
                        {app.telefono && app.telefono !== '-' && (
                          <>
                            ...
                            <a
                              ...
                              target="_blank"
                              rel="noreferrer"
                              className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-white/[0.05] hover:bg-emerald-500/10 flex items-center justify-center transition-colors mr-3"
                              title="WhatsApp"
                            >
                              <MessageSquare className="w-3.5 h-3.5 text-white/50 hover:text-emerald-400" />
                            </a>
                          </>
                        )}
